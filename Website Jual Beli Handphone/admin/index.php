<?php 
session_start();
$koneksi=new mysqli("localhost","root","","uas_files");
...
<head>
    ...
    <title>Web UAS Agung Setio Aji</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMIN AGUNG</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> &nbsp; <a href="login.php" class=""></a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
